...
for i in range(0, 2):
    ...
    if percent:
        writeCSV('ASHE Pensions Table 4 Percentages {p}{y}.csv'.format(y=year,p=prov), conversionsegments)
    else:
        writeCSV('ASHE Pensions Table 4 Values {p}{y}.csv'.format(y=year, p=prov), conversionsegments)
